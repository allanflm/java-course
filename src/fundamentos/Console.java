...
public class Console {
    public static void main(String[] args) {
        ...
        System.out.println("Dia"); // println -> imprime e pula uma linha

        System.out.printf("MegaSena: %d %d %d %d", 1, 2, 3, 4);// printf -> imprime formatado

        System.out.printf("\nSalario: R$%.1f\n", 1234.5678);
        System.out.printf("Nome: %s\n", "Allan");

        Scanner input = new Scanner(System.in);// para ler algo do teclado.
        ...
        System.out.printf("Idade digitada: %d", idade);
     ...
     * nextDouble(). Ambos os métodos têm a mesma particularidade, mas vou
     ...
     * 
     * teclado.close();
     * À primeira vista, parece que está tudo bem com este código. Mas quando o
     * rodamos, o que é impresso no console (contendo os inputs) é o seguinte:
     * 
     * Qual a sua idade? 25
     * Qual o seu nome? Qual o seu sobrenome? Silva
     * Isso acontece por causa da maneira como o nextInt() faz a leitura dos
     * valores.
     * 
